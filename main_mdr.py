...
from generators.generator import MDRGenerator
from trainers.mdr_trainer import MDRTrainer
from utils.utils import set_seed
from utils.logger import Logger
from utils.argument import *

import setproctitle
setproctitle.setproctitle("LLMoEMDR")
...
def main():
    ...
    if args.model_name in ["llmoemdr",]:
        generator = MDRGenerator(args, logger, device)
    else:
        raise ValueError
